...
//        Text t4 = new Text(centerX - 3, centerY + clockRadius - 3, "6");
        ...
        for (int i = 0; i < 60; i++) {
            double linesLength, space = 18;

            // draw the hour and lines for every minute
            // for hour the lines are longer
            if (i % 5 != 0) {
                linesLength = 5;
            } else {
                double x = centerX + (clockRadius - space) *
                        Math.sin(i * (2 * Math.PI / 60));
                double y = centerY - (clockRadius - space) *
                        Math.cos(i * (2 * Math.PI / 60));
                Text hour = new Text(x - 3, y + 3, (i / 5) + "");
                getChildren().add(hour);
                linesLength = 10;
            }

            double startX = centerX + (clockRadius - linesLength) *
                    Math.sin(i * (2 * Math.PI / 60));
            double startY = centerY - (clockRadius - linesLength) *
                    Math.cos(i * (2 * Math.PI / 60));
